...
EXTRA_USERS_PARAMS_fara3 = "${EXTRA_USERS_PARAMS_MODIFY}"
# python __anonymous() {
...
PACKAGE_INSTALL_append_fara3 = " ${@['', 'sudo'][bool(d.getVar('EXTRA_USERS_SUDOERS'))]}"

ROOTFS_POSTPROCESS_COMMAND_append_fara3 = " set_sudoers;"
...
ROOTFS_POSTPROCESS_COMMAND_fara3 += "rootfs_fixup_sshd_config; "
