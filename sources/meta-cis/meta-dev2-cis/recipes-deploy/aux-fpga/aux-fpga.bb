...
SRC_URI:append:apple = " file://zynqmp_fsbl_slave_apple.elf "
SRC_URI:append:grape = " file://zynqmp_fsbl_slave_apple.elf "

S = "${WORKDIR}"

DEPENDS:append = " auxfpgaload-native "

PACKAGES_LIST:append = " aux-fpga "
