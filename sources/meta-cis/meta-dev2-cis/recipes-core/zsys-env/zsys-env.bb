...
ENV_FILE_PLAT_SAKU:remove:hu = " file://zsys-cis-env_saku.env.in "
ENV_FILE_PLAT_SAKU:append:hu = " file://zsys-cis-env_hu.env.in "

ENV_FILE_PLAT_SAKU:remove:apple = " file://zsys-cis-env_saku.env.in "
ENV_FILE_PLAT_SAKU:append:apple = " file://zsys-cis-env_apple.env.in "

ENV_FILE_PLAT_SAKU:remove:grape = " file://zsys-cis-env_saku.env.in "
ENV_FILE_PLAT_SAKU:append:grape = " file://zsys-cis-env_grape.env.in "
SRC_URI:append:saku = "${ENV_FILE_PLAT_SAKU}"
