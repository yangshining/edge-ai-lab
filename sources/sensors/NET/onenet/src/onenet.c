/**
	...
	*	File Name: 	onenet.c
	*
	*	Author: 	Zhang Jinhong
	*
	*	Date: 		2017-05-08
	*
	*	Version: 	V1.1
	*
	*	Description: Interface layer for data interaction with OneNET platform
	*
	*	Revision History:
	*				V1.0: Protocol encapsulation and interrupt handling in the same file, different protocol interfaces are different
	*				V1.1: Provide unified interface for application use, encapsulate protocol-specific data according to different protocols
	************************************************************
	************************************************************
	************************************************************
**/
...
//==========================================================
//	Function Name:	OneNET_RegisterDevice
//
//	Function:		Register a device in the product
//
//	Input:			access_key - access key
//					pro_id - product ID
//					serial - unique device serial number
//					devid - returned devid
//					key - returned key
//
...
//==========================================================
//	Function Name:	OneNet_DevLink
//
//	Function:		Connect to OneNET platform
//
//	Input:			None
//
//	Return:			1-success	0-failure
//
//	Description:	Connect to OneNET platform
//==========================================================
...
extern int mq2_vol, light_pct, light_th, smog_th;
...
//==========================================================
//	Function Name:	OneNet_SendData
//
//	Function:		Upload data to platform
//
//	Input:			type - format of uploaded data
//
//	Return:			None
//
//	Description:	
...
//==========================================================
//	Function Name:	OneNET_Subscribe
//
//	Function:		Subscribe
//
//	Input:			None
...
//
//	Function:		Platform data processing
//
//	Input:			dataPtr - data returned by platform
//
//	Return:			None
//
//	Description:	
