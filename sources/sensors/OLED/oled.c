...
// Author       : Evk123
// Date         : 2014-01-01
// Description  : 0.69 inch OLED display driver (STM32F103ZE series IIC)
//              Pin connections: 
//              ----------------------------------------------------------------
//              GND   -> Ground
...
// Display BMP picture 128x64 starting coordinates (x,y), x range 0~127, y is page range 0~7
